...
class TestLoader:
    ...
    def test_valid_loader_init(self):
        loader = Loader(model_weights_path="../files/yolov3.weights",
                        model_config_path="../files/yolov3.cfg",
                        coco_names="../files/coco.names")
    ...
    def test_load_onnx_yolo(self, config_load):
        config = config_load 
        config.model_weights_path = "../files/yolov3.onnx"
        loader = Loader.load_from_config(config)
